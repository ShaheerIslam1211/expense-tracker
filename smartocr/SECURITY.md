...
If you find a security vulnerability in ocr_image_to_text, please report it through [GitHub's private vulnerability reporting](https://github.com/ShaheerIslam1211/smartocr/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact shaheer.muzaffar.7@gmail.com for details.
